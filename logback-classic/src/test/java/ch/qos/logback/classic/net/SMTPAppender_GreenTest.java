...
public class SMTPAppender_GreenTest {
    ...
    public void testCustomEvaluator() throws Exception {
        configure(greenMailServer.getSmtp().getPort(), ClassicTestConstants.JORAN_INPUT_PREFIX + "smtp/customEvaluator.xml");
    ...
    public void testCustomBufferSize() throws Exception {
        configure(greenMailServer.getSmtp().getPort(), ClassicTestConstants.JORAN_INPUT_PREFIX + "smtp/customBufferSize.xml");
